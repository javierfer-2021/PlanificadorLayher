...
export class FrmCompraDetallesComponent implements OnInit,AfterViewInit {
  ...
  cols: Array<ColumnDataGrid> = [
    ...
    {
      dataField: 'Excepcion',
      caption: this.traducir('frm-compra-detalles.colExcepcion','Exc.'),
      visible: true, 
      dataType: 'boolean',
      width: 50,
    },                
  ...
  cerrarEditarLinea(e){
    if (e != null) {     
      ...
      if (this.arrayLineasEntrada[this.lineaSeleccionadaIndex].CantidadCancelada != e.CantidadCancelada) {
        this.arrayLineasEntrada[this.lineaSeleccionadaIndex].CantidadCancelada = e.CantidadCancelada;
      }       
